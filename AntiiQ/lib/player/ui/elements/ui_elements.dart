...
class ButtonStyles {
  final ButtonStyle style1 = ButtonStyle(
    backgroundColor: MaterialStateProperty.all(currentColorScheme.background),
    foregroundColor: MaterialStateProperty.all(currentColorScheme.primary),
    ...
    textStyle: MaterialStateProperty.all(TextStyles().onPrimaryText),
  );

  final ButtonStyle style2 = ButtonStyle(
    backgroundColor: MaterialStateProperty.all(currentColorScheme.primary),
    foregroundColor: MaterialStateProperty.all(currentColorScheme.background),
    surfaceTintColor: MaterialStateProperty.all(Colors.transparent),
    elevation: MaterialStateProperty.all(5.0),
    padding: MaterialStateProperty.all(EdgeInsets.symmetric(horizontal: 10)),
    shape: MaterialStateProperty.all(
    ...
    textStyle: MaterialStateProperty.all(TextStyles().onBackgroundText),
  );

  final ButtonStyle style3 = ButtonStyle(
    backgroundColor: MaterialStateProperty.all(currentColorScheme.secondary),
    foregroundColor: MaterialStateProperty.all(currentColorScheme.onSecondary),
    surfaceTintColor: MaterialStateProperty.all(Colors.transparent),
    elevation: MaterialStateProperty.all(5.0),
    padding: MaterialStateProperty.all(EdgeInsets.symmetric(horizontal: 10)),
    shape: MaterialStateProperty.all(
